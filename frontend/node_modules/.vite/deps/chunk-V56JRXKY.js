...
var je = (a, t, s) => t in a ? Ke(a, t, { enumerable: true, configurable: true, writable: true, value: s }) : a[t] = s;
var S = (a, t, s) => (je(a, typeof t != "symbol" ? t + "" : t, s), s);
var ae = class extends InstancedMesh {
  /**
...
var vs = 6 * 4 + 4 + 4;
var Ms = 65535;
var We = Math.pow(2, -24);
var Os = Symbol("SKIP_GENERATION");
function Qe(a) {
...
var ft = 32;
var ri = (a, t) => a.candidate - t.candidate;
var gt = new Array(ft).fill().map(() => ({
  count: 0,
...
var ie = function() {
  ...
  return function(i, n, o, r) {
    ...
    if (c >= 0 && c <= 1 && f >= 0 && f <= 1) {
      ...
      const h = t, u = s;
      if (i.closestPointToPoint(b, true, t), n.closestPointToPoint(l, true, s), h.distanceToSquared(b) <= u.distanceToSquared(l)) {
        o.copy(h), r.copy(b);
        return;
      } else {
        o.copy(l), r.copy(u);
...
var ot = class extends Triangle {
  constructor(...t) {
    super(...t), this.isExtendedTriangle = true, this.satAxes = new Array(4).fill().map(() => new Vector3()), this.satBounds = new Array(4).fill().map(() => new _t()), this.points = [this.a, this.b, this.c], this.sphere = new Sphere(), this.plane = new Plane(), this.needsUpdate = true;
  }
  intersectsSphere(t) {
    return _i(t, this);
  }
  update() {
    ...
    const u = n[3], _ = o[3];
    u.subVectors(e, t), _.setFromPoints(u, i), this.sphere.setFromPoints(this.points), this.plane.setFromNormalAndCoplanarPoint(r, t), this.needsUpdate = false;
  }
};
...
ot.prototype.intersectsTriangle = function() {
  const a = new ot(), t = new Array(3), s = new Array(3), e = new _t(), i = new _t(), n = new Vector3(), o = new Vector3(), r = new Vector3(), c = new Vector3(), f = new Vector3(), l = new Line3(), b = new Line3(), h = new Line3(), u = new Vector3();
  function _(w, y, d) {
    const p = w.points;
    let I = 0, m = -1;
    for (let g = 0; g < 3; g++) {
  ...
  return function(y, d = null, p = false) {
    ...
    if (Math.abs(I.normal.dot(m.normal)) > 1 - 1e-10) {
      ...
      return d && (p || console.warn("ExtendedTriangle.intersectsTriangle: Triangles are coplanar which does not support an output edge. Setting edge to 0, 0, 0."), d.start.set(0, 0, 0), d.end.set(0, 0, 0)), true;
    } else {
      const g = _(this, m, b);
      if (g === 1 && y.containsPoint(b.end))
        return d && (d.start.copy(b.end), d.end.copy(b.end)), true;
      if (g !== 2)
        return false;
      const A = _(y, I, h);
      if (A === 1 && this.containsPoint(h.end))
        return d && (d.start.copy(h.end), d.end.copy(h.end)), true;
      if (A !== 2)
        return false;
      ...
      return F !== v && C !== x && M === V ? false : (d && (f.subVectors(b.start, h.start), f.dot(r) > 0 ? d.start.copy(b.start) : d.start.copy(h.start), f.subVectors(b.end, h.end), f.dot(r) < 0 ? d.end.copy(b.end) : d.end.copy(h.end)), true);
    }
  };
}();
...
var H = class {
  constructor(t, s, e) {
    this.isOrientedBox = true, this.min = new Vector3(), this.max = new Vector3(), this.matrix = new Matrix4(), this.invMatrix = new Matrix4(), this.points = new Array(8).fill().map(() => new Vector3()), this.satAxes = new Array(3).fill().map(() => new Vector3()), this.satBounds = new Array(3).fill().map(() => new _t()), this.alignedSatBounds = new Array(3).fill().map(() => new _t()), this.needsUpdate = false, t && this.min.copy(t), s && this.max.copy(s), e && this.matrix.copy(e);
  }
  set(t, s, e) {
...
H.prototype.intersectsTriangle = function() {
  const a = new ot(), t = new Array(3), s = new _t(), e = new _t(), i = new Vector3();
  return function(o) {
...
function $s(a, t, s, e, i = null, n = 0, o = 0) {
  ...
  if (Z(l, c)) {
    ...
    return R(a, r, At), e(h, u, false, o, n + a, At);
  } else {
    let v = function(V) {
...
function xi(a, t, s, e, i, n, o, r, c) {
  ...
  if (f) {
    e && (bs.fromBufferAttribute(e, n), us.fromBufferAttribute(e, o), ds.fromBufferAttribute(e, r), f.uv = Triangle.getInterpolation(_s, Et, Gt, Rt, bs, us, ds, new Vector2())), i && (bs.fromBufferAttribute(i, n), us.fromBufferAttribute(i, o), ds.fromBufferAttribute(i, r), f.uv1 = Triangle.getInterpolation(_s, Et, Gt, Rt, bs, us, ds, new Vector2())), s && (de.fromBufferAttribute(s, n), _e.fromBufferAttribute(s, o), pe.fromBufferAttribute(s, r), f.normal = Triangle.getInterpolation(_s, Et, Gt, Rt, de, _e, pe, new Vector3()), f.normal.dot(a.direction) > 0 && f.normal.multiplyScalar(-1));
    const l = {
      a: n,
      b: o,
      c: r,
    ...
    Triangle.getNormal(Et, Gt, Rt, l.normal), f.face = l, f.faceIndex = n;
  }
  return f;
}
...
function Vi(a, t, s, e, i, n, o) {
  ...
  for (let l = a, b = t + a; l < b; l++) {
    let h;
    if (h = l, k(o, h * 3, c, f), o.needsUpdate = true, e(o, h, i, n))
      return true;
  }
  return false;
}
function Fi(a, t = null) {
  ...
  function b(h, u, _ = false) {
    ...
    if (r[w + 15] === Ms) {
      ...
      return c[h + 0] !== I || c[h + 1] !== m || c[h + 2] !== g || c[h + 3] !== A || c[h + 4] !== F || c[h + 5] !== x ? (c[h + 0] = I, c[h + 1] = m, c[h + 2] = g, c[h + 3] = A, c[h + 4] = F, c[h + 5] = x, true) : false;
    } else {
      const d = h + 8, p = o[h + 6], I = d + u, m = p + u;
      let g = _, A = false, F = false;
      t ? g || (A = t.has(I), F = t.has(m), g = !A && !F) : (A = true, F = true);
      const x = g || A, C = g || F;
      let v = false;
      x && (v = b(d, u, g));
      let M = false;
...
function Mi(a, t, s, e, i, n, o) {
  ...
  for (let l = a, b = t + a; l < b; l++) {
    let h;
    if (h = s.resolveTriangleIndex(l), k(o, h * 3, c, f), o.needsUpdate = true, e(o, h, i, n))
      return true;
  }
  return false;
}
...
function Ys(a, t, s, e, i = null) {
  ...
  if (i === null && (s.boundingBox || s.computeBoundingBox(), Ie.set(s.boundingBox.min, s.boundingBox.max, e), i = Ie), Z(c, o)) {
    ...
    if (Qt.copy(e).invert(), s.boundsTree)
      return R(a, n, ms), ms.matrix.copy(Qt), ms.needsUpdate = true, s.boundsTree.shapecast({
        ...
        intersectsTriangle: (p) => {
          ...
          for (let I = w * 3, m = (y + w) * 3; I < m; I += 3)
            if (k(kt, I, b, h), kt.needsUpdate = true, p.intersectsTriangle(kt))
              return true;
          return false;
        }
      });
    for (let d = w * 3, p = (y + w) * 3; d < p; d += 3) {
      k(Nt, d, b, h), Nt.a.applyMatrix4(Qt), Nt.b.applyMatrix4(Qt), Nt.c.applyMatrix4(Qt), Nt.needsUpdate = true;
      for (let I = 0, m = u.count; I < m; I += 3)
        if (k(kt, I, u, _), kt.needsUpdate = true, Nt.intersectsTriangle(kt))
          return true;
    }
  } else {
    const l = a + 8, b = r[a + 6];
...
function Ei(a, t, s, e = {}, i = {}, n = 0, o = 1 / 0) {
  t.boundingBox || t.computeBoundingBox(), zs.set(t.boundingBox.min, t.boundingBox.max, s), zs.needsUpdate = true;
  ...
  return ys.copy(s).invert(), ts.matrix.copy(ys), a.shapecast(
    {
      ...
      intersectsBounds: (g, A, F) => F < p && F < o ? (A && (ts.min.copy(g.min), ts.max.copy(g.max), ts.needsUpdate = true), true) : false,
      intersectsRange: (g, A) => {
        if (t.boundsTree)
          return t.boundsTree.shapecast({
            ...
            intersectsRange: (x, C) => {
              for (let v = x, M = x + C; v < M; v++) {
                k(u, 3 * v, b, l), u.a.applyMatrix4(s), u.b.applyMatrix4(s), u.c.applyMatrix4(s), u.needsUpdate = true;
                for (let V = g, P = g + A; V < P; V++) {
                  k(h, 3 * V, f, c), h.needsUpdate = true;
          ...
          });
        {
          ...
          for (let x = 0, C = F; x < C; x++) {
            k(u, 3 * x, b, l), u.a.applyMatrix4(s), u.b.applyMatrix4(s), u.c.applyMatrix4(s), u.needsUpdate = true;
...
function Ws(a, t, s, e, i = null) {
  ...
  if (i === null && (s.boundingBox || s.computeBoundingBox(), Ae.set(s.boundingBox.min, s.boundingBox.max, e), i = Ae), Z(c, o)) {
    ...
    if (ss.copy(e).invert(), s.boundsTree)
      return R(a, n, Is), Is.matrix.copy(ss), Is.needsUpdate = true, s.boundsTree.shapecast({
        intersectsBounds: (p) => Is.intersectsBox(p),
        intersectsTriangle: (p) => {
          p.a.applyMatrix4(e), p.b.applyMatrix4(e), p.c.applyMatrix4(e), p.needsUpdate = true;
          for (let I = w, m = y + w; I < m; I++)
            if (k(Kt, 3 * t.resolveTriangleIndex(I), b, h), Kt.needsUpdate = true, p.intersectsTriangle(Kt))
              return true;
          return false;
        }
      });
    for (let d = w, p = y + w; d < p; d++) {
      ...
      k(qt, 3 * I, b, h), qt.a.applyMatrix4(ss), qt.b.applyMatrix4(ss), qt.c.applyMatrix4(ss), qt.needsUpdate = true;
      for (let m = 0, g = u.count; m < g; m += 3)
        if (k(Kt, m, u, _), Kt.needsUpdate = true, qt.intersectsTriangle(Kt))
          return true;
    }
  } else {
    const l = a + 8, b = r[a + 6];
...
function Xi(a, t, s, e = {}, i = {}, n = 0, o = 1 / 0) {
  t.boundingBox || t.computeBoundingBox(), Es.set(t.boundingBox.min, t.boundingBox.max, s), Es.needsUpdate = true;
  const r = a.geometry, c = r.attributes.position, f = r.index, l = t.attributes.position, b = t.index, h = Q.getPrimitive(), u = Q.getPrimitive();
  ...
  return ws.copy(s).invert(), es.matrix.copy(ws), a.shapecast(
    {
      ...
      intersectsBounds: (g, A, F) => F < p && F < o ? (A && (es.min.copy(g.min), es.max.copy(g.max), es.needsUpdate = true), true) : false,
      intersectsRange: (g, A) => {
        if (t.boundsTree) {
            ...
            intersectsRange: (x, C) => {
              for (let v = x, M = x + C; v < M; v++) {
                ...
                for (let P = g, B = g + A; P < B; P++) {
                  ...
                  k(h, 3 * O, f, c), h.needsUpdate = true;
...
var ns = new G.constructor();
var Cs = new G.constructor();
var It = new ne(() => new Box3());
var jt = new Box3();
var $t = new Box3();
var Gs = new Box3();
var Rs = new Box3();
...
function it(a, t, s, e, i, n = 0, o = 0, r = 0, c = 0, f = null, l = false) {
  let b, h;
...
var oe = class _oe {
  ...
  static deserialize(t, s, e = {}) {
    ...
    const { index: i, roots: n, indirectBuffer: o } = t, r = new _oe(s, { ...e, [Os]: true });
  ...
  constructor(t, s = {}) {
    ...
    this.geometry = t, this._roots = null, this._indirectBuffer = null, s[Os] || (ui(this, s), !t.boundingBox && s.setBoundingBox && (t.boundingBox = this.getBoundingBox(new Box3())));
  ...
  shapecast(t) {
    ...
    if (o && r) {
      const b = o;
      o = (h, u, _, w, y) => b(h, u, _, w, y) ? true : e(h, u, this, r, _, w, s);
    } else
    ...
    if (n) {
      const _ = (w, y, d, p, I, m, g, A) => {
        for (let F = d, x = d + p; F < x; F++) {
          u(F), l.a.applyMatrix4(s), l.b.applyMatrix4(s), l.c.applyMatrix4(s), l.needsUpdate = true;
          for (let C = w, v = w + y; C < v; C++)
            if (f(C), o.needsUpdate = true, n(o, l, C, F, I, m, g, A))
              return true;
        }
        return false;
      };
      if (i) {
        ...
        i = function(y, d, p, I, m, g, A, F) {
          return w(y, d, p, I, m, g, A, F) ? true : _(y, d, p, I, m, g, A, F);
        };
      } else
        i = _;
    }
  ...
  intersectsBox(t, s) {
    return xs.set(t.min, t.max, s), xs.needsUpdate = true, this.shapecast(
      {
...
var os = class os2 {
   ...
   */
  static apply(t) {
    os2.initialized || (BufferGeometry.prototype.computeBoundsTree = Qi, BufferGeometry.prototype.disposeBoundsTree = tn, Mesh.prototype.raycast = Wi, os2.initialized = true), t.boundsTree || t.computeBoundsTree();
  }
  /**
...
var Ue = class {
  ...
  constructor(t, s, e) {
    ...
    S(this, "_settingVisibility", false);
...
var ut = 4;
var W = 4;
var wt = new Int32Array(2);
var Ce = new Float32Array(wt.buffer);
var Pe = new Float64Array(wt.buffer);
var As = new Uint16Array(new Uint8Array([1, 0]).buffer)[0] === 1;
var Qs;
(function(a) {
...
var Dt = class _Dt {
   ...
   */
  static allocate(t) {
    return new _Dt(new Uint8Array(t));
  }
  clear() {
    this.position_ = 0;
  }
...
var rs = class _rs {
  ...
  prep(t, s) {
    ...
    for (; this.space < e + t + s; ) {
      ...
      this.bb = _rs.growByteBuffer(this.bb), this.space += this.bb.capacity() - i;
    }
    this.pad(e);
  }
  pad(t) {
...
var sn = class {
  ...
  setInstances(t, s) {
    ...
    for (let f = 0; f < o.length; f++) {
      ...
      for (let w = 0; w < b; w++) {
        const y = c * 16, d = e.subarray(y, y + 17), p = new Matrix4().fromArray(d);
        if (h.push(p), i) {
          const I = c * 3, [m, g, A] = i.subarray(I, I + 4), F = new Color(m, g, A);
          u.push(F);
        }
        c++;
      }
  ...
  constructFragmentGroup(t) {
    ...
    if (e) {
      ...
      for (let M = 0; M < v; M++) {
        const V = new LineBasicMaterial({ color: 16777215 }), P = new Ne(), B = e.alignments(M);
        if (!B)
  ...
  constructCivilCurves(t, s, e, i, n) {
    ...
    for (let r = 0; r < i; r++) {
      ...
      const b = c.data();
      b && (l = JSON.parse(b));
      const h = new EdgesGeometry(), u = new BufferAttribute(f, 3);
...
var bt = class _bt {
  ...
  static getRootAsCivilData(t, s) {
    return (s || new _bt()).__init(
      t.readInt32(t.position()) + t.position(),
      t
    );
  }
  static getSizePrefixedRootAsCivilData(t, s) {
    return t.setPosition(t.position() + W), (s || new _bt()).__init(
      t.readInt32(t.position()) + t.position(),
      t
    );
  }
  ...
  static createCivilData(t, s, e) {
    return _bt.startCivilData(t), _bt.addAlignments(t, s), _bt.addCoordinationMatrix(t, e), _bt.endCivilData(t);
  }
};
var N = class _N {
  constructor() {
  ...
  static getRootAsFragment(t, s) {
    return (s || new _N()).__init(t.readInt32(t.position()) + t.position(), t);
  }
  static getSizePrefixedRootAsFragment(t, s) {
    return t.setPosition(t.position() + W), (s || new _N()).__init(t.readInt32(t.position()) + t.position(), t);
  }
  position(t) {
    const s = this.bb.__offset(this.bb_pos, 4);
    return s ? this.bb.readFloat32(this.bb.__vector(this.bb_pos + s) + t * 4) : 0;
  ...
  static createFragment(t, s, e, i, n, o, r, c, f, l, b, h, u) {
    return _N.startFragment(t), _N.addPosition(t, s), _N.addNormal(t, e), _N.addIndex(t, i), _N.addGroups(t, n), _N.addMaterials(t, o), _N.addMatrices(t, r), _N.addColors(t, c), _N.addItemsSize(t, f), _N.addIds(t, l), _N.addId(t, b), _N.addCapacity(t, h), _N.addCapacityOffset(t, u), _N.endFragment(t);
  }
};
var js = class ee {
  constructor() {
...
var en = class {
  ...
  constructFragmentGroup(t) {
    const s = new Re(), e = t.civil();
    if (e) {
      const v = e.coordinationMatrixArray(), M = new Matrix4();
      v && M.fromArray(v), s.civilData = { alignments: /* @__PURE__ */ new Map(), coordinationMatrix: M };
      const V = e.alignmentsLength();
      for (let P = 0; P < V; P++) {
        const B = new LineBasicMaterial({ color: 16777215 }), O = new Ne(), D = e.alignments(P);
        if (!D)
          throw new Error("Alignment not found!");
...
var Re = class extends Group {
  constructor() {
    super(...arguments);
    S(this, "items", []);
    S(this, "boundingBox", new Box3());
    S(this, "coordinationMatrix", new Matrix4());
...
var nt = class _nt {
  ...
  static getRootAsStreamedGeometry(t, s) {
    return (s || new _nt()).__init(
      t.readInt32(t.position()) + t.position(),
      t
    );
  }
  static getSizePrefixedRootAsStreamedGeometry(t, s) {
    return t.setPosition(t.position() + W), (s || new _nt()).__init(
      t.readInt32(t.position()) + t.position(),
      t
    );
  }
  ...
  static createStreamedGeometry(t, s, e, i, n) {
    return _nt.startStreamedGeometry(t), _nt.addGeometryId(t, s), _nt.addPosition(t, e), _nt.addNormal(t, i), _nt.addIndex(t, n), _nt.endStreamedGeometry(t);
  }
};
var xt = class _xt {
  constructor() {
  ...
  static getRootAsStreamedGeometries(t, s) {
    return (s || new _xt()).__init(
      t.readInt32(t.position()) + t.position(),
      t
    );
  }
  static getSizePrefixedRootAsStreamedGeometries(t, s) {
    return t.setPosition(t.position() + W), (s || new _xt()).__init(
      t.readInt32(t.position()) + t.position(),
      t
    );
  }
  ...
  static createStreamedGeometries(t, s) {
    return _xt.startStreamedGeometries(t), _xt.addGeometries(t, s), _xt.endStreamedGeometries(t);
  }
};
var fn = class {
  /**
...
//# sourceMappingURL=chunk-V56JRXKY.js.map
